...
export function AuditLogDetailsDialog({
  ...
  return (
    <>
      ...
      <GlobalModal open={open} onClose={() => setOpen(false)} titleId={titleId}>
        <div className="flex min-h-full flex-1 items-center justify-center overflow-y-auto px-4 py-4 sm:px-6 sm:py-8">
          <div className="glass-panel-strong my-auto flex max-h-[calc(100vh-2rem)] w-full max-w-5xl flex-col overflow-hidden rounded-[1.75rem] shadow-[0_18px_42px_rgba(4,17,29,0.24)] sm:max-h-[calc(100vh-4rem)]">
